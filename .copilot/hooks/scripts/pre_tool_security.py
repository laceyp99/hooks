...
MUTATING_FILE_TOOLS = FILE_ACCESS_TOOLS - {"read_file"}
...
def _should_check(tool_name: str) -> bool:
    return tool_name.lower() in FILE_ACCESS_TOOLS


def _should_check_git_paths(tool_name: str) -> bool:
    return tool_name.lower() in MUTATING_FILE_TOOLS
...
def _find_env_path(value: Any) -> str | None:
    ...
    return value if _matches_env_path(value) else None
...
def _find_protected_git_path(value: Any) -> str | None:
    ...
    return value if _matches_protected_git_path(value) else None
